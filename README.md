...
pnpm dsh plugin --profile web add -w github:lovstudio/dsh-plugin-marketplace#v0.1.8
pnpm dsh web
```
...
```sh
npx @deepseek-ai/dsh plugin --profile web add -w github:lovstudio/dsh-plugin-marketplace#v0.1.8
